...
const PinDetails = ({ user }) => {
  ...
  return (
    <>
      ...
      {pins?.length > 0 ? (
        <>
          <h2 className="text-center font-bold text-2xl mt-8 mb-4 text-gray-600">Related pins</h2>
          <MasonryLayout pins={pins} />
        </>
      ) : (
        <h2 className="text-center font-bold text-2xl mt-8 mb-4">Sorry, there are no relative pins yet...</h2>
      )}
    </>
  );
};
